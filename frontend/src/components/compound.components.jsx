...
export function createCompound({
  ...
  //console.log(viewCounters, viewHistogram, viewChartTotalCases);

  switch ((viewCounters, viewHistogram, viewChartTotalCases)) {
    case viewCounters && viewHistogram && viewChartTotalCases:
      return (
        <div>
