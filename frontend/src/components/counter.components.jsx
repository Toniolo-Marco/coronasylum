...
import "../scss/counter.module.css";

export default function Counter(props) {
  useEffect(() => {
    const element = document.querySelector(".cool-element");
    const numberInput = document.querySelector(".number-input");
    const numberSubmit = document.querySelector(".number-button");
  ...
  return (
    <React.Fragment>
      <div>
        <div className="cool-element"></div>
        <input className="number-input" type="number" value="123" />
        <button className="number-button">Start The Counter</button>
      </div>
    </React.Fragment>
  );
}
